 ...
 * @author snake
 */
public class BarraNavegacion extends javax.swing.JFrame {

    /**
     * Creates new form BarraNavegacion
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BarraNavegacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BarraNavegacion().setVisible(true);
            }
        });
    }
